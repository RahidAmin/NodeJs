...
app.post("/contact-us", (req, res, next) => {
    console.log("First Handling contact us for url : ", req.body);
...
app.post("/contact-us", (req, res, next) => {
    console.log("Second Handling,after addin body-parser: ", req.body);
    res.send(`<p>${(req.body.name)},${req.body.email}</p>`);
